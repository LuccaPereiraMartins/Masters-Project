...
# Any input within training range seems to lead to the same output. MP model clearly a bit broken
# print(pd.DataFrame(mp.predict(np.array([83800, 43.5, 7.7, 12400, 31.1, 11]).reshape(1,-1))))
# print(pd.DataFrame(mp.predict(np.array([83800, 43.5, 7.7, 12400, 31.1, 9]).reshape(1,-1))))
# print(pd.DataFrame(mp.predict(np.array([85437.20254,42.499796,8.257449,7312.748956,34.808689,11]).reshape(1,-1))))
# print(pd.DataFrame(ystar))

# When asked to predict the training data it still doesn't work, clear issues...
# print(yp)
# print(pd.DataFrame(mp.predict(xp))) 
...
# print(mean_squared_error(ytrue,yhpredstar[0]))
# print(mean_squared_error(ytrue,ylpred[0]))
# print(mean_squared_error(ytrue,yallpred[0]))
# print(mean_squared_error(ytrue,yallshortpred[0]))
...
# Consider cross-correlation metric too

# for i in predictions:
#     print(np.correlate(ytrue,i[0])) 

# print(mean_squared_error(ytrue,y10))
# print(np.correlate(ytrue,y10))
